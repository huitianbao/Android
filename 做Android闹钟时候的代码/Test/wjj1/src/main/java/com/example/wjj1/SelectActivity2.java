...
public class SelectActivity2 extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_selectactivity2);
        ...
        timePicker.setOnTimeChangedListener(new TimePicker.OnTimeChangedListener() {
            ...
            public void onTimeChanged(TimePicker timePicker, int i, int i1) {
                ...
                c_hour=i;
                c_min=i1;
                Toast toast2= Toast.makeText(SelectActivity2.this,"您选择的时间:"+c_hour+":"+c_min,Toast.LENGTH_LONG);
        ...
        datePicker.init(d_year,d_month,d_day, new DatePicker.OnDateChangedListener(){
            ...
            public void onDateChanged(DatePicker datePicker, int i, int i1, int i2) {
                int month_tmp;
                SelectActivity2.this.d_year = i;
                SelectActivity2.this.d_month = i1;
                SelectActivity2.this.d_day = i2;

                month_tmp=d_month+1;


                Toast toast1=Toast.makeText(SelectActivity2.this, "您选择的日期：" + d_year + "年  "
        ...
        button_con.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(SelectActivity2.this,MainActivity.class);
                ...
                dataTime.setName("SelectActivity2");
                intent.putExtra("msg2", dataTime);
        ...
        button_cal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("msg22", dataTime);
                startActivity(intent);
            }
        });
    ...
    private void cancel_set(){
        ...
        Intent intent = new Intent(SelectActivity2.this, ClockActivity.class);
        pi = PendingIntent.getActivity(SelectActivity2.this, 0, intent, 0);
